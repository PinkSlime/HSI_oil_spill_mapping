%%%%%%%%%%%%%  Demo for Hyperspectral Image Classification via Multiscale Adaptive Sparse Representation   
%===========================================================================
% Author: Leyuan Fang
% Affiliation: College of Electrical and Information Engineering, Hunan University, Changsha, China
% Email:fangleyuan@gmail.com
%===========================================================================
clc
close all
clear all
...
[OA_class,kappa_class,AA_class,CA_class] = confusion(tt_lab,tt_ID);
...
%             
%             Y = I_row;
%             X = ceil(Index_test{i}(j)/I_row);
%         else
%             Y = mod(Index_test{i}(j),I_row);
%             X = ceil(Index_test{i}(j)/I_row);
%         end
%         
...
%             
%             Y = I_row;
%             X = ceil(Index_train{i}(j)/I_row);
%         else
%             Y = mod(Index_train{i}(j),I_row);
%             X = ceil(Index_train{i}(j)/I_row);
%         end
% 
%         resultmap(X,Y) = i;
